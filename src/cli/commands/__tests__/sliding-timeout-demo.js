...
class SlidingTimeoutDemo extends EventEmitter {
	constructor() {
		super()
		this.timeout = null
...
async function runDemo() {
	...
	const demo1 = new SlidingTimeoutDemo()
	demo1.on("timeout", () => {
		console.log("❌ Task timed out due to inactivity!\n")
	})
	await new Promise((resolve) => setTimeout(resolve, 6000))

	console.log("Scenario 2: Task with periodic activity")
...
module.exports = { SlidingTimeoutDemo }
