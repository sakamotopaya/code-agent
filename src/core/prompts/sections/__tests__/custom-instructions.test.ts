...
describe("loadRuleFiles", () => {
	...
	it("should not combine content from multiple rule files when they exist", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().endsWith(".agentzrules")) {
	...
	it("should use .agentz/rules/ directory when it exists and has files", async () => {
		// Simulate .agentz/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				parentPath: "/fake/path/.agentz/rules",
			},
			{
				name: "file2.txt",
				isFile: () => true,
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString() === "/fake/path/.agentz/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (filePath.toString() === "/fake/path/.agentz/rules/file2.txt") {
		...
		const result = await loadRuleFiles("/fake/path")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/file1.txt:")
		expect(result).toContain("content of file1")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/file2.txt:")
		...
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules")
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/file1.txt")
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/file2.txt")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/file1.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/file2.txt", "utf-8")
	})

	it("should fall back to .agentzrules when .agentz/rules/ is empty", async () => {
		// Simulate .agentz/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: jest.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .agentz/rules/", async () => {
		// Simulate .agentz/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: jest.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.agentz/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.agentz/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (path === "/fake/path/.agentz/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (path === "/fake/path/.agentz/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (path === "/fake/path/.agentz/rules/subdir/subdir2/nested2.txt") {
		...
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/root.txt:")
		expect(result).toContain("root file content")

		// Check nested files content
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/subdir/nested1.txt:")
		expect(result).toContain("nested file 1 content")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/subdir/subdir2/nested2.txt:")
		expect(result).toContain("nested file 2 content")

		// Verify correct paths were checked
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/root.txt")
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/subdir/nested1.txt")
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/subdir/subdir2/nested2.txt")

		// Verify files were read with correct paths
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/root.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/subdir/nested1.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/subdir/subdir2/nested2.txt", "utf-8")
	})
})
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .agentz/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
		...
		expect(result).toContain("Rules from .agentzrules-test-mode:\nmode specific rules")
	})
	...
	it("should use .agentz/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .agentz/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: jest.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.agentz/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString() === "/fake/path/.agentz/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (filePath.toString() === "/fake/path/.agentz/rules-test-mode/rule2.txt") {
		...
		expect(result).toContain("# Rules from /fake/path/.agentz/rules-test-mode")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules-test-mode/rule1.txt:")
		expect(result).toContain("mode specific rule 1")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules-test-mode/rule2.txt:")
		expect(result).toContain("mode specific rule 2")

		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules-test-mode")
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules-test-mode/rule1.txt")
		expect(statMock).toHaveBeenCalledWith("/fake/path/.agentz/rules-test-mode/rule2.txt")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules-test-mode/rule1.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules-test-mode/rule2.txt", "utf-8")
	})

	it("should fall back to .agentzrules-test-mode when .agentz/rules-test-mode/ does not exist", async () => {
		// Simulate .agentz/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })

		// Simulate .agentzrules-test-mode exists
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".agentzrules-test-mode")) {
	...
	it("should fall back to .clinerules-test-mode when .agentz/rules-test-mode/ and .agentzrules-test-mode do not exist", async () => {
		// Simulate .agentz/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should correctly format content from directories when using .agentz/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.agentz/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
		...
		statMock.mockImplementation((filePath) => {
			statCallCount++
			if (filePath === "/fake/path/.agentz/rules-test-mode/rule1.txt") {
				return Promise.resolve({
					isFile: jest.fn().mockReturnValue(true),
					isDirectory: jest.fn().mockReturnValue(false),
				} as any)
...
describe("Rules directory reading", () => {
	it("should follow symbolic links in the rules directory", async () => {
			...
			.mockResolvedValueOnce([
				{
					...
					isFile: () => true,
					parentPath: "/fake/path/.agentz/rules/symlink-target-dir",
				},
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.agentz/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: jest.fn().mockReturnValue(true),
					isFile: jest.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString() === "/fake/path/.agentz/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (filePath.toString() === "/fake/path/.agentz/rules/../symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (filePath.toString() === "/fake/path/.agentz/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (filePath.toString() === "/fake/path/.agentz/rules/../nested-symlink-target.txt") {
		...
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/regular.txt:")
		expect(result).toContain("regular file content")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/../symlink-target.txt:")
		expect(result).toContain("symlink target content")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/symlink-target-dir/subdir_link.txt:")
		expect(result).toContain("regular file content under symlink target dir")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/../nested-symlink-target.txt:")
		expect(result).toContain("nested symlink target content")

		// Verify readlink was called with the symlink path
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/../symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith(
			"/fake/path/.agentz/rules/symlink-target-dir/subdir_link.txt",
			"utf-8",
		)
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.agentz/rules/../nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		jest.clearAllMocks()
	})
	...
	it("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.agentz/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.agentz/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.agentz/rules" },
		] as any)

		statMock.mockImplementation((path) => {
			expect([
				"/fake/path/.agentz/rules/file1.txt",
				"/fake/path/.agentz/rules/file2.txt",
				"/fake/path/.agentz/rules/file3.txt",
			]).toContain(path)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (filePath.toString() === "/fake/path/.agentz/rules/file3.txt") {
		...
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/file2.txt:")
		expect(result).toContain("content of file2")
		expect(result).toContain("# Rules from /fake/path/.agentz/rules/file3.txt:")
